...
def intro1():
    ...
    print(f'{Fore.LIGHTRED_EX}  .////:`      ``-://///////-.`  `-///- {Style.RESET_ALL}')
    print(f'{Fore.LIGHTRED_EX} `///////---::/::-.-:///:-`     .:///:` {Style.RESET_ALL}')
    print(f'{Fore.LIGHTRED_EX} -/////:--..``` `.---.`      `.::-:/:`  {Style.RESET_ALL}{Fore.CYAN}Repo{Style.RESET_ALL}: https://github.com/thepasswordspoiler')
    print(f'{Fore.LIGHTRED_EX} :///:.`..                `.:/:.`-/:`   {Style.RESET_ALL}{Fore.CYAN}Email{Style.RESET_ALL}: athrmane4@gmail.com') 
    print(f'{Fore.LIGHTRED_EX} :///` .:.            `.-::-.` `-//-    {Style.RESET_ALL}{Fore.CYAN}License{Style.RESET_ALL}: opensource')
    print(f'{Fore.LIGHTRED_EX} .//. `....``         -/-`    .:///.    {Style.RESET_ALL}')
